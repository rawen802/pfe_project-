...
class MainWindow(QMainWindow):
    ...
    def show_page(self, page_name):
        """
        Navigation centralisée utilisée par DashboardPage.
        Cette méthode permet aux boutons du Dashboard d'ouvrir les vraies pages.
        """
    ...
    def logout(self):
        """
        Ferme la session utilisateur de manière stable.

        Important :
        - MainWindow ne doit pas créer directement LoginPage.
        - Il émet seulement un signal logout_requested.
        - Le fichier main.py doit recevoir ce signal et rouvrir LoginPage.
        """
        ...
        # Nettoyer le token côté frontend
        self.api.token = None
        ...
        # Demander à main.py de rouvrir LoginPage
        self.logout_requested.emit()

        # Fermer uniquement cette fenêtre principale
        self.close()
